...
public class Director implements Disposable
{
	...
	public void setWidthHeight(int width, int height)
	{
		...
		if (scene != null)
			scene.setViewport(new ExtendViewport (width, height));

		
		System.out.println("setWidthHeight "+width);
	...
	public void recalcScaleFactors(int width, int height)
	{
		...
		System.out.println("recalcScaleFactors" +width+" "+height);
	...
	public void setStretch(boolean stretch)
	{
		...
		if (scene != null)
		{
			scene.setViewport(new  StretchViewport(width, height));
		}
		System.out.println("setStretch");
