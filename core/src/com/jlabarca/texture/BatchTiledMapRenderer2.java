...
public abstract class BatchTiledMapRenderer2 implements TiledMapRenderer, Disposable {
	...
	public BatchTiledMapRenderer2 (TiledMap map) {
		this(map, 1.0f);
	}

	public BatchTiledMapRenderer2 (TiledMap map, float unitScale) {
		this.map = map;
	...
	public BatchTiledMapRenderer2 (TiledMap map, Batch batch) {
		this(map, 1.0f, batch);
	}

	public BatchTiledMapRenderer2 (TiledMap map, float unitScale, Batch batch) {
		this.map = map;
		this.unitScale = unitScale;
		this.viewBounds = new Rectangle();
